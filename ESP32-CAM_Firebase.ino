...
const char* ssid = "VIART";
const char* password = "Dezvoltare";

//https://console.firebase.google.com/project/xxxxxxxxxx/settings/serviceaccounts/databasesecrets
String FIREBASE_HOST = "esp32-79d80-default-rtdb.firebaseio.com";
String FIREBASE_AUTH = "8kIzqz5NiuvJExw3k9uurYQHrjpzApNg4zyUPSpY";
